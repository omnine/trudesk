...
import TypesensesearchSettingsContainer from './Typesensesearch'
        ...
        <div className='uk-width-1-6 uk-width-xLarge-1-10 message-list full-height' data-offset='68'>
          ...
          <div className='page-content-left noborder full-height'>
            <Menu>
              ...
              />
              <MenuItem
                title={'Typesensesearch'}
                active={this.state.activeCategory === 'settings-typesensesearch'}
                onClick={e => {
                  this.onMenuItemClick(e, 'typesensesearch')
                }}
              />
              <MenuItem
                title={'EWS'}
        ...
        <div className='uk-width-5-6 uk-width-xLarge-9-10'>
          ...
          <div className='page-wrapper full-height scrollable no-overflow-x' ref={i => (this.page = i)}>
            <div className='settings-wrap'>
              ...
              <TypesensesearchSettingsContainer active={this.state.activeCategory === 'settings-typesensesearch'} />
